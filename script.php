    ...
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav mx-auto">
                <li class="nav-item">
                    <a class="nav-link" href="sobreNos.php"><b>SOBRE NOS</b></a>
                </li>
               
                <li class="nav-item">
                    <a class="nav-link" href="rent.php"><b>RENT-A-CAR</b></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="loja.php"><b>LOJA</b></a>
                </li>
                <li class="nav-item">
